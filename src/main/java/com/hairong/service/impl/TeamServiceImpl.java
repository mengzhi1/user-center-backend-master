...
import com.hairong.mapper.TeamMapper;
...
import com.hairong.model.enums.TeamStatusEnum;
...
import com.hairong.service.TeamService;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("hairong:join_team");
        try {
            // 抢到锁并执行
            while (true) {
    ...
    public boolean quitTeam(TeamQuitRequest teamQuitRequest, User loginUser) {
        ...
        queryUserTeam.setTeamId(userId);
